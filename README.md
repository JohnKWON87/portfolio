    ...
    <div class="container">
        ...
        <section id="about">
            ...
            <div class="about-content">
                ...
                <p>2025년 4월부터 8개월간 풀스택 개발자 과정을 이수하며 Java, Spring Boot를 중심으로 학습했고, 4개의 팀 프로젝트를 완수하며 실무 역량을 쌓았습니다.</p>
                <p>현장에서 얻은 끈기와 협업 경험을 바탕으로, 사용자에게 실제 도움이 되는 서비스를 구현하는 개발자를 목표로 하고 있습니다.</p>
            </div>
        </section>
